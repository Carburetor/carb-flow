...
describe Carb::Flow::Transaction::ExecutableAction do
  ...
  before do
    ...
    @service    = -> {}
    @step_args  = { foo: :bar }
    @executable = Carb::Flow::Transaction::ExecutableAction.new(
      @step,
      @service,
      @step_args
    )
  ...
  it "can be initialized with 3 args" do
    Carb::Flow::Transaction::ExecutableAction.new(:foo, :bar, [123])
  end
